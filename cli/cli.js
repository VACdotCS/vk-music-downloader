...
export async function mainMenu(config = global['myConfig']) {
  const choices = [
    "🎶 Скачать все треки из основного плейлиста", // 0
    "🎶 Скачать все плейлисты", // 1
    "🔗 Скачать трек по ссылке", // 2
    "🔗 Скачать плейлист по ссылке", // 3
    "⚙️ Показать путь для скачивания", // 4
    "⚙️ Изменить путь для скачивания", // 5
