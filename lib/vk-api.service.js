...
class VkApiService {
  ...
  async getTracksOfPlaylistByLink(link) {
    ...
    try {
      ...
      console.log(audioListResponse, list);
...
vkApiService.getTracksOfPlaylistByLink('https://vk.com/music/playlist/-13228624_84459240_89b37323a0330b0823').catch(e => console.error(e)).then(result => console.log(result));